 ...
 */
@Getter
public class WarenEinlagernEvent2 extends BusinessObjectEvent {
    ...
    public WarenEinlagernEvent2(EpcisEvent event) {
    ...
    public static IntellipackBusinessEventFactory<ProduktionEvent1> getFactory() {
        if (FACTORY == null){
            ...
            validator.addRule(new ValidationRule(EventPredicates.hasDisposition(Disposition.IN_PROGRESS), "Event disposition should IN_PROGRESS! "));
