 ...
 */
@Getter
public class AbgelaufeneWareImLadenEvent7 extends BusinessObjectEvent {
    ...
    private static final Predicate<EpcisEvent> PREDICATE = isEventType(EventType.OBJECT)
            ...
            .and(EventPredicates.hasDisposition(Disposition.NON_SELLABLE_OTHER))
    ...
    public AbgelaufeneWareImLadenEvent7(EpcisEvent event) {
    ...
    public static IntellipackBusinessEventFactory<ProduktionEvent1> getFactory() {
        if (FACTORY == null){
            ...
            validator.addRule(new ValidationRule(EventPredicates.hasDisposition(Disposition.NON_SELLABLE_OTHER), "Event disposition should be NON_SELLABLE_OTHER! "));
