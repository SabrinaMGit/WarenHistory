 ...
 */
@Getter
public class ImStoreImLagerEvent6 extends BusinessObjectEvent {
    ...
    private static final Predicate<EpcisEvent> PREDICATE = isEventType(EventType.OBJECT)
            ...
            .and(EventPredicates.hasDisposition(Disposition.SELLABLE_NOT_ACCESSIBLE))
    ...
    public ImStoreImLagerEvent6(EpcisEvent event) {
    ...
    public static IntellipackBusinessEventFactory<ProduktionEvent1> getFactory() {
        if (FACTORY == null){
            ...
            validator.addRule(new ValidationRule(EventPredicates.hasDisposition(Disposition.SELLABLE_NOT_ACCESSIBLE), "Event disposition should be SELLABLE_NO_ACCESSIBLE! "));
